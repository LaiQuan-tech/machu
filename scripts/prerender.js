...
const ROUTES = [
  ...
  {
    // 歲時祭曆。這一頁的內容是資料庫來的（deity_feasts ＋ blessing_events），
    ...
    path: '/calendar',
    priority: '0.7',
    title: '歲時祭曆｜神明聖誕與壇務活動｜台北古亭和聖壇',
    desc: '和聖壇年度歲時祭曆：神明聖誕與壇務活動一覽。聖誕依農曆記載，本表已換算為當年國曆日期，並標示星期。',
    h1: '歲時祭曆',
    body: [
      '和聖壇的年度歲時祭曆，依月份列出神明聖誕與壇務活動。',
